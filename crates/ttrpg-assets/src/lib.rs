...
//! let service = RustAssetService::new(cache_dir, None)?;
//! 
...
pub mod prelude {
    ...
    pub use crate::service::{RustAssetService, AssetType};
    pub use crate::http_client::{EnhancedHttpClient, HttpClientConfig};
    pub use crate::memory_cache::{MemoryCache, CacheManager, CacheConfig};
}

// Re-export main service for easy access
pub use service::{RustAssetService, AssetType};
