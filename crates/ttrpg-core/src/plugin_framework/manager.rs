...
mod tests {
    ...
    fn test_available_formats() {
        ...
        let plugin2 = OutputPluginRegistry::FoundryModule(
            crate::plugin_framework::registry::FoundryModuleHandler,
        );
