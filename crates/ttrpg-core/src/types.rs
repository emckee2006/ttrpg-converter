...
impl Campaign {
    ...
    pub fn update_stats(&mut self) {
        ...
        stats.entity_counts.insert("actors".to_string(), self.actors.len());
        stats.entity_counts.insert("scenes".to_string(), self.scenes.len());
        stats.entity_counts.insert("items".to_string(), self.items.len());
        stats.entity_counts.insert("journal".to_string(), self.journal.len());
        stats.entity_counts.insert("tables".to_string(), self.tables.len());
        stats.entity_counts.insert("playlists".to_string(), self.playlists.len());
        stats.entity_counts.insert("macros".to_string(), self.macros.len());
